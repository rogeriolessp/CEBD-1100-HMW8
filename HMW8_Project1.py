...
def parsarg():
    ...
    parser.add_argument("-h", dest="argv1", help="test", type=int)
    parser.add_argument("-p", dest="argv2", help="test", type=int, action='append')
    parser.add_argument("-q", dest="argv3", help="test", type=str, default="test3")
